...
const int analogCenterX = 124;
const int analogCenterY = 122;
const int analogLeft = 23;
...
// Array of pins the servos are attached to, index: {0=>Front Right, 1=>Back Right, 2=>Front Left, 3=>Back Left}
int pins[] = {3, 10, 9, 11};
