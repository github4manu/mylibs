...
{
    print( LCD_CMD );
    print( LCD_CMD_CLEAR_SCREEN );
}

void LCDSerial::gotoLineOne(void)
{
    print( LCD_CMD );
    print( LCD_CMD_POS_LINE_ONE);
}
void LCDSerial::gotoLineTwo(void)
{
    print( LCD_CMD );
    print( LCD_CMD_POS_LINE_TWO );
}

void LCDSerial::backlightOn(void)
{
    print( LCD_BACKLIGHT );
    print( LCD_BACKLIGHT_MAX );
}

void LCDSerial::backlightOff(void)
{
    print( LCD_BACKLIGHT );
    print( LCD_BACKLIGHT_MIN );
}
