...
const word DSM_SEND_INTERVAL = 20; 

#ifdef DE_JITTER
const byte DE_JITTER_MIN_PULSE_LEN_CHANGE = 25;
#endif
...
const byte BIND_UPDATE_INTERVAL = 100;
...
void setup() {   
  ...
  #ifdef TX_ACTIVE
  timer.every(BIND_UPDATE_INTERVAL, &updateTXState);
  #endif  
